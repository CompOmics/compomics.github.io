...
permalink: /projects/icelogoserver
---
...
IceLogo server is the server edition of the [iceLogo](/projects/icelogo) tool. IceLogo server can be accessed via http://iomics.ugent.be/icelogoserver/. You can also host your own instance if necessary. Download the *war* file in the [download](#download) section.
...
## Usage
Installation instructions can be found on the [wiki](/projects/icelogoserver/wiki) page. See the [manual](http://iomics.ugent.be/icelogoserver/manual) page for the usage of the application.
