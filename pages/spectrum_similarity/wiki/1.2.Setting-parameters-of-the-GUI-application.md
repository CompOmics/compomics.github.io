...
layout: default
permalink: "/projects/spectrum_similarity/wiki/1.2.Setting-parameters-of-the-GUI-application"
...
`Noise filter` enables noise filtering by removing peaks. Currently, there are three options avaliable: none, [pride-asap](https://github.com/compomics/pride-asa-pipeline)-adaptive noise filtering, topN intense peak selection and discarding peaks with less than x% of precursor intensity
