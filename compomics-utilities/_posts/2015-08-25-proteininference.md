...
Peptide to protein mapping is implemented in software like [OpenMS](http://open-ms.sourceforge.net/) or [PeptideShaker](https://code.google.com/p/peptide-shaker/) and in standalone services like in the [Protein Information Resource](http://proteininformationresource.org/peptide.shtml) or in the [compomics-utilities package](https://code.google.com/p/compomics-utilities/).
