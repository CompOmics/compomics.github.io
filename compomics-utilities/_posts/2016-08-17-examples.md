...
To infer proteins from a given set of peptides or a sequence tags with a given proteome, utilities provides a peptide mapping tool. A performance benchmark can be reviewed [here](peptidemapper-benchmark).
