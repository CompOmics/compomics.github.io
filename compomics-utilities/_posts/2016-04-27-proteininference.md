...
Peptide to protein mapping is implemented in software like [OpenMS](http://open-ms.sourceforge.net/) or [PeptideShaker](http://compomics.github.io/projects/peptide-shaker.html) and in standalone services like in the [Protein Information Resource](http://proteininformationresource.org/peptide.shtml) or in the [compomics-utilities package](http://compomics.github.io/projects/compomics-utilities.html).
