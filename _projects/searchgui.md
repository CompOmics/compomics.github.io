...
|   |   |   |
| :------------------------- | :--------------- | :--: |
| [![download](https://github.com/compomics/searchgui/wiki/images/download_button_windows.png)](http://genesis.ugent.be/maven2/eu/isas/searchgui/SearchGUI/2.5.0/SearchGUI-2.5.0-windows.zip) | *v2.5.0 - Windows* | [ReleaseNotes](/searchgui/wiki/releasenotes.html) | 
| [![download](https://github.com/compomics/searchgui/wiki/images/download_button_unix.png)](http://genesis.ugent.be/maven2/eu/isas/searchgui/SearchGUI/2.5.0/SearchGUI-2.5.0-mac_and_linux.tar.gz) | *v2.5.0 - Mac and Linux* |[ReleaseNotes](/searchgui/wiki/releasenotes.html) | 
